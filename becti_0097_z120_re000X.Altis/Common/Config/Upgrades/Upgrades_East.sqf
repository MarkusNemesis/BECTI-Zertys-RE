...
_l=_l+			[["Factory: Aircraft FFAR", "Unlocks the FFAR Rockets for Aircrafts"]];
_a=_a	+			[true];
_c=_c +			[[10000]];
_lev=_lev+	[1];
...
_l=_l+			[["Factory: Aircraft AT", "Unlocks the Anti Tank Missiles for Aircrafts"]];
...
_l=_l+			[["Factory: Aircraft AA", "Unlocks the Anti Air Missiles for Aircrafts"]];
...
_l=_l+			[["Factory: Aircraft Countermeasures", "Allows Aircraft to deploy countermeasures"]];
_a=_a	+			[(missionNamespace getVariable "CTI_VEHICLES_AIR_AT")==1];
_c=_c +			[[8000]];
_lev=_lev+	[1];
_lin=_lin+	[[[CTI_UPGRADE_AIR, 1]]];
